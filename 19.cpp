...
int* MergeSorting(int *up, int *down, unsigned int left, unsigned int right);
...
int* MergeSorting(int *up, int *down, unsigned int left, unsigned int right)
{
    ...
    int *l_buff = MergeSorting(up, down, left, middle);
    int *r_buff = MergeSorting(up, down, middle + 1, right);
